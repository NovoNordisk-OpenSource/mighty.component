...
#> → Found "/tmp/RtmpwQy2WK/file1a9761dbe9ef.mustache" in "."
r2base
#> <mighty_component/R6>
#> file1a9761dbe9ef.mustache: Ratio to baseline
#> Type: column
#> Parameters:
...
#> → Found "/tmp/RtmpwQy2WK/file1a974e6c0134.mustache" in "."
...
#> → Found "/tmp/RtmpwQy2WK/file1a976b5b6683.mustache" in "."
#> [1] "ADAE <- ADAE |>"                                             
