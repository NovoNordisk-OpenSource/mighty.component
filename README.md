...
mighty.standards serve as a repository of generic compute nodes used to
produce ADaM scripts in the {mighty} framework.

## Installation

You can install the development version of `mighty.standards` from
GitHub with:
