...
In our framework, a "node" is a function that processes input data and returns a modified version with new columns or rows. 
...
1. Include an example using appropiate data from {pharmaversesdtm} and {pharmaverseadam}
...
#' @export
your_new_node <- function(.self, param1, param1) {
